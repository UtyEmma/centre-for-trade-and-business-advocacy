                    ...
                    <div class="tp-sidebar-widget mb-45">
                        <div class="tp-sidebar-widget-bg tp-sidebar-widget-category">
                            ...
                            <div class="rc-post-wrap">
                                <div class="rc-post-item d-flex align-items-center mb-20 pb-20">
                                ...
                                <div class="rc-post-content">
                                    ...
                                    <h3 class="rc-post-title">
                                        <a class="tp-line-anim" href="blog-details.html">Neque or senectus <br> sole licitudin </a>
                                    </h3>
                                </div>
                                </div>
                                <div class="rc-post-item d-flex align-items-center mb-20 pb-20">
                                ...
                                <div class="rc-post-content">
                                    ...
                                    <h3 class="rc-post-title">
                                        <a class="tp-line-anim" href="blog-details.html">The next generation of <br> leather alternatives</a>
                                    </h3>
                                </div>
                                </div>
                                <div class="rc-post-item d-flex align-items-center">
                                <div class="rc-post-thumb">
                                    <a href="blog-details.html">
                                ...
                                <div class="rc-post-content">
                                    ...
                                    <h3 class="rc-post-title">
                                        <a class="tp-line-anim" href="blog-details.html">Freelancer Days 2026, <br> What’s new?</a>
                                    </h3>
                                </div>
                                </div>
                            </div>
