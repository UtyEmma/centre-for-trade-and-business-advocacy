<main>
         ...
         <!-- contact area start -->
         <div class="tp-contact-ptb tp-sec-ptb pt-135 pb-95">
            <div class="container">
               <div class="row">
                  <div class="col-lg-5">
                     <div class="tp-contact-wrapper mb-30">
                        <div class="tp-contact-heading mb-60">
                           <span class="tp-section-sub tp-fade-anim">Let’s Connect</span>
                           <h3 class="tp-section-title" data-text-split data-letters-fade-in>We’re ready to support <br> your financial journey.</h3>
                        </div>
                        <div class="tp-contact-info tp-fade-anim" data-delay=".5">
                           ...
                           <div class="tp-contact-info-item mb-30">
                              <div class="tp-contact-info-icon">
                                 <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="18" viewBox="0 0 20 18" fill="none">
                                       <path d="M17.5 5C18.8807 5 20 3.88071 20 2.5C20 1.11929 18.8807 0 17.5 0C16.1193 0 15 1.11929 15 2.5C15 3.88071 16.1193 5 17.5 5Z" fill="#222F30"/>
                                       <path d="M17.5 5C18.8807 5 20 3.88071 20 2.5C20 1.11929 18.8807 0 17.5 0C16.1193 0 15 1.11929 15 2.5C15 3.88071 16.1193 5 17.5 5Z" fill="#222F30"/>
                                       <path d="M18.72 6.31C19.35 6.11 20 6.6 20 7.27V12.51C20 16.01 18 17.51 15 17.51H5C2 17.51 0 16.01 0 12.51V5.50999C0 2.00999 2 0.509995 5 0.509995H12.61C13.26 0.509995 13.7 1.11001 13.58 1.74001C13.46 2.33001 13.48 2.96 13.66 3.61C14.03 4.95 15.12 6.02 16.46 6.37C17.25 6.56999 18.02 6.53 18.72 6.31Z" fill="#222F30"/>
                              ...
                              <div class="tp-contact-info-content">
                                 ...
                                 <p><a class="tp-line-anim" href="mailto:info@gmail.com">info@gmail.com</a></p>
                              </div>
                           </div>
                           <div class="tp-contact-info-item">
                              <div class="tp-contact-info-icon">
                                 <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                    <path d="M16.4738 14.83L16.8638 17.99C16.9638 18.82 16.0738 19.4 15.3638 18.97L11.1738 16.48C10.7138 16.48 10.2638 16.45 9.82376 16.39C10.5638 15.52 11.0038 14.42 11.0038 13.23C11.0038 10.39 8.54375 8.09003 5.50375 8.09003C4.34375 8.09003 3.27376 8.42 2.38376 9C2.35376 8.75 2.34375 8.49999 2.34375 8.23999C2.34375 3.68999 6.29375 0 11.1738 0C16.0538 0 20.0038 3.68999 20.0038 8.23999C20.0038 10.94 18.6138 13.33 16.4738 14.83Z" fill="#222F30"/>
                                    <path d="M11 13.23C11 14.42 10.56 15.52 9.82001 16.39C8.83001 17.59 7.26 18.36 5.5 18.36L2.89 19.91C2.45 20.18 1.89 19.81 1.95 19.3L2.2 17.33C0.859997 16.4 0 14.91 0 13.23C0 11.47 0.940005 9.92 2.38 9C3.27 8.42 4.34 8.09003 5.5 8.09003C8.54 8.09003 11 10.39 11 13.23Z" fill="#222F30"/>
                                    </svg>
                                 </span>
                              </div>
                              <div class="tp-contact-info-content">
                                 <p><a class="tp-line-anim" href="#">Start Chat</a></p>
                              </div>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="col-lg-7">
                     <div class="tp-contact-from mb-30 tp-fade-anim" data-delay=".5" data-fade-from="right">
                        <form id="contact-form" action="https://html.aqlova.com/consora-prev/consora/assets/mail.php" method="POST">
                           <div class="row">
                              <div class="col-12">
                                 ...
                                 <div class="tp-contact-input mb-15">
                                    <input placeholder="Your website*" name="subject" type="text">
                                 </div>
                                 <div class="tp-contact-input mb-15">
                                    <textarea placeholder="How can we help? Fell free to write here" name="message"></textarea>
                                 </div>
         ...
         <!-- contact area start -->
         <div class="tp-contact-banner-ptb pb-130">
            <div class="container">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="tp-contact-banner-thumb">
                        <img class="radius-6" src="assets/img/finance/banner/banner-bg-2.jpg" alt="">
                     </div>
                  </div>
               </div>
            </div>
         ...
         <!-- city area start -->
         <div class="tp-contact-city-ptb pb-110">
            <div class="container">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="tp-contact-city-heading text-center mb-70">
                        <span class="tp-section-sub tp-fade-anim">Our office address</span>
                        <h3 class="tp-section-title" data-text-split data-letters-fade-in>Our World Offices are located across <br> major global cities.</h3>
                     </div>
                  </div>
               </div>
               <div class="row">
                     ...
                     <div class="tp-contact-city-item text-center mb-30">
                        ...
                        <div class="tp-contact-city-item-content">
                           ...
                           <div class="tp-contact-city-item-contact">
                              <a class="tp-line-anim" href="tel:0123456789">+1 (406) 555-0120</a>
                           </div>
                           <div class="tp-contact-city-item-contact">
                              <a class="tp-line-anim" href="mailto:hello@example.com">hello@example.com</a>
                           </div>
                        </div>
                     </div>
                  </div>
