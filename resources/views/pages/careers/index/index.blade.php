<main>
    ...
    <div class="tp-career-join-ptb pt-130">
        <div class="container col-md-11 mx-auto">
            <div class="row">
                <div class="col-lg-12">
                    <div class="tp-career-join-heading text-center pb-60 mb-80">
                        <h3 class="tp-section-title mb-15" data-text-split data-letters-fade-in>Join at consora</h3>
                        <p class="mb-30">Explore our teams, learn about our culture, and find your next opportunity.</p>
                        ...
                        <div class="tp-career-join-rating tp-fade-anim" data-delay=".7">
                            <p>
                                <span>
                                    4.5
                ...
                <div class="col-lg-12">
                    <div class="tp-career-join-gallery-wrapper text-center z-index-1">
                        <h3 class="tp-section-title mb-25 col-md-7 mx-auto" data-text-split data-letters-fade-in>“Giving entrepreneurs the freedom to succeed starts with creating the conditions for our team to learn every day.”</h3>

                        <p>Alex Prot & Steve Anavi – Consora Co-Founders</p>
    ...
    <!-- career area start -->
    <div class="tp-career-ptb pt-140" data-bg-color="#F7F7F5">
        <div class="container col-md-10 mx-auto">
            <div class="tp-career-top-wrap pb-70">
                <div class="row">
                    <div class="col-lg-7">
                        <div class="tp-career-heading mb-30">
                            <span class="tp-section-sub tp-fade-anim">Culture and community</span>
                            <h3 class="tp-section-title" data-text-split data-letters-fade-in>We invest in our people to
                                <br> drive lasting success.</h3>
                        </div>
                    </div>
                    <div class="col-lg-5">
                        <div class="tp-career-text mb-30 tp-fade-anim" data-delay=".5">
                            <p>We engineer bespoke financial workflows using elite accounting technology to deliver seamless, high-precision bookkeeping. From high-stakes hospitality to complex legal and medical practices, we provide the clarity you need to lead. </p>
                            <p>Custom workflows. Cutting-edge tech. We provide seamless bookkeeping solutions for demanding industries—including medical, legal, and luxury hospitality so you can focus on scaling. Eliminate financial friction with tailored workflows powered by industry-leading tech. We transform bookkeeping into a competitive advantage for leaders in real</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="tp-career-bottom-wrap">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="tp-career-item mb-30 radius-6 p-relative tp-fade-anim" data-bg-color="#CEF79E">
                            <div class="tp-career-item-content">
                                <span class="tp-career-item-sub">Award and recognition</span>
                                <h3 class="tp-career-item-title">
                                    <a href="career-details.html">
                                        Awarded by experts <br> valued by our team
                                    </a>
                                </h3>
                                <a class="tp-btn tp-btn-switch-animation" href="career-details.html">
                                    <span class="d-flex align-items-center justify-content-center">
                                        <span class="btn-text">
                                            See open position
                                        </span>
                    ...
                    <div class="col-lg-5">
                        <div class="tp-career-thumb-wrap mb-30 tp-fade-anim" data-delay=".5">
                            <img class="radius-6 w-100" src="assets/img/finance/career/career-img-1.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="tp-career-thumb-wrap mb-30 tp-fade-anim" data-delay=".7">
                            <img class="radius-6 w-100" src="assets/img/finance/career/career-img-2.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-end">
                    <div class="col-lg-6">
                        <div class="tp-fa-control-heading mb-60">
                            <h3 class="tp-section-title corporate-color" data-text-split data-letters-fade-in>Complete
                                control over your <br> finances on the go.</h3>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="tp-fa-control-right d-flex flex-wrap gap-lg-5 gap-3 align-items-center justify-content-lg-end mb-60 tp-fade-anim"
                            data-delay=".5">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="tp-fa-control-item mb-30 tp-fade-anim">
                            ...
                            <div class="tp-fa-control-item-content">
                                ...
                                <p>Usability refers to the measurement of how easily and efficiently a user can accomplish their goals when using a product, system.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
    ...
    <!-- role area start -->
    <div class="tp-career-role-ptb tp-sec-ptb pt-130 pb-140" data-bg-color="#222F30">
        <div class="container col-md-10 mx-auto">
