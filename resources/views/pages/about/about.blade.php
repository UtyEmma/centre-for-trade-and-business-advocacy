<main>
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="tp-about-thumb-wrap h-100  mb-30 tp-fade-anim" data-fade-from="left">
                        <img class="radius-6 h-100 object-cover" src="assets/img/finance/about/about-1.jpg"  alt="">
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="tp-about-wrapper">
                        <div class="tp-fi-about-content pb-50">
                            <span class="tp-section-sub tp-fade-anim">Know about us</span>
                            <h3 class="tp-section-title mb-20" data-text-split data-letters-fade-in>Inspiring innovation
                                and driving growth <br> through customized business plans</h3>
                            <div class="tp-fade-anim" data-delay=".5">
                                <p>At Consora, we believe in transforming ideas into impactful digital solutions. As a
                                    forward-thinking agency, we specialize in <br>
                                    empowering businesses to thrive in the digital era. From cutting-edge web
                                    development to strategic digital marketing, <br>
                                    Our team is dedicated to creating tailored solutions that drive growth.</p>
                            </div>
                        </div>
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-7">
                                <div class="tp-about-fact-wrap tp-fade-anim" data-delay=".7">
                                    <div class="tp-about-fact-item">
                                        <h3 class="tp-about-fact-item-title"><i class="purecounter fst-normal"
                                                data-purecounter-duration="2" data-purecounter-end="50"></i>+</h3>
                                        <p>A passionate team industry experts in design.</p>
                                    </div>
                                    <div class="tp-about-fact-item">
                                        <h3 class="tp-about-fact-item-title"><i class="purecounter fst-normal"
                                                data-purecounter-duration="2" data-purecounter-end="15"></i>+</h3>
                                        <p>Serving diverse industries worldwide.</p>
                                    </div>
                                    <div class="tp-about-fact-item m-0 p-0 border-0">
                                        <h3 class="tp-about-fact-item-title"><i class="purecounter fst-normal"
                                                data-purecounter-duration="2" data-purecounter-end="20"></i>+</h3>
                                        <p>Empowering global businesses to thrive.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <!-- about vision area start -->
    <div class="tp-about-vision-ptb pt-80 pb-50" data-bg-color="#F7F7F5">
        <div class="container col-md-10 mx-auto">
            <div class="row">
                <div class="col-lg-12">
                    <div class="tp-about-vision-content mb-55">
                        <span class="tp-section-sub tp-fade-anim">Our vision</span>
                        <h3 class="tp-section-title fs-32 mb-20" data-text-split data-letters-fade-in>Leading the future
                            of business innovation and digital transformation</h3>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6">
                    <div class="tp-about-vision-item mb-30 tp-fade-anim" data-delay=".5">
                        <div class="tp-about-vision-item-icon">
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 45 45"
                                    fill="none">
                                    <path
                                        d="M40.9706 6.87414C36.4697 2.47269 30.3652 0 24 0C17.6348 -7.5e-07 11.5303 2.47269 7.02944 6.87414C2.52857 11.2755 7.5e-07 17.2451 0 23.4697C-7.5e-07 29.6942 2.52856 35.6638 7.02944 40.0652L40.9706 6.87414Z"
                                        fill="#CEF79E" />
                                    <path d="M44.8086 23.2827H23.8086V44.2827H44.8086V23.2827Z" fill="#222F30" />
                                </svg>
                            </span>
                        </div>
                        <div class="tp-about-vision-item-content">
                            <h4 class="tp-about-vision-item-title">Driving digital transformation</h4>
                            <p>Our vision is to be at the forefront of digital transformation, helping <br> businesses
                                embrace new technologies to stay competitive.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="tp-about-vision-item mb-30 tp-fade-anim" data-delay=".7">
                        <div class="tp-about-vision-item-icon">
                            <span>
                        ...
                        <div class="tp-about-vision-item-content">
                            <h4 class="tp-about-vision-item-title">Building strong partnerships</h4>
                            <p>We seek to build long-term relationships with our clients, becoming <br> their trusted
                                partner in innovation and growth.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="tp-fi-value-thumb-wrapper p-relative  mb-30 mt-30">
                        ...
                        <div class="tp-fi-value-graph p-relative tp-fade-anim" data-delay=".5">
                                ...
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="14" viewBox="0 0 15 14"
                                        ...
                                        <path
                                            ...
                                            stroke="#222F30" stroke-miterlimit="10" stroke-linecap="round"
                            ...
                            <h3 class="tp-fi-value-graph-title">Sales revenue</h3>
                            <span class="tp-fi-value-graph-date">April 01-30</span>
                            <div class="tp-fi-value-graph-count d-flex justify-content-between">
                                <span>+769,5%</span>
                                <p>Increase since <br> last week</p>
                            </div>
                            <div class="tp-fi-value-graph-range"></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="tp-fi-value-content mb-30">
                        <div class="tp-fi-value-heading">
                            <span class="tp-section-sub tp-fade-anim">Our core values</span>
                            <h3 class="tp-section-title mb-30" data-text-split data-letters-fade-in>Insight at the core.
                                Independent <br> strategy in action.</h3>
                            <div class="tp-fade-anim" data-delay=".5">
    ...
    <!-- success area start -->
    <div class="tp-cn-success-ptb pb-110">
        <div class="container col-md-10 mx-auto">
            <div class="row">
                <div class="col-lg-6">
                    <div class="tp-cn-success-item mb-30 radius-6 p-relative"
                        ...
                        <div class="tp-cn-success-item-content pb-200">
                            ...
                            <h3 class="tp-cn-success-item-title" data-text-split data-letters-fade-in>Powering an 80%
                                surge in real-time <br>
                ...
                <div class="col-lg-6">
                    <div class="tp-cn-success-item-2 mb-30" data-background="assets/img/consulting/success/thumb-1.jpg">
                        ...
                        <div class="tp-cn-success-item-2-content tp-fade-anim" data-delay=".5" data-fade-from="right"
                            ...
                            <p>This year is significant because it provides <br> insight into the history and experience
                            </p>
                        </div>
                    </div>
                </div>
