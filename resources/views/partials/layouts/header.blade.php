<div class="tp-search-area p-relative">
    <div class="tp-search-wrapper">
        <div class="tp-search-close">
            <button type="button" class="tp-search-close-btn">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="tp-search-input p-relative mb-60">
                        <input type="text" placeholder="What are you looking for?">
                        <button type="submit" class="tp-search-input-btn">
...
<header class="tp-header-height">
    <div class="tp-header-bottom d-none d-md-block" data-bg-color="#CEF79E">
        <div class="container container-1800 col-md-10 mx-auto">
            <div class="row justify-content-between">
                <div class="col-md-6">
                    <div class="tp-header-info">
                        <a class="tp-line-anim" href="#"><span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="20" viewBox="0 0 16 20"
                                    fill="none">
                                    <path
                                        d="M14.75 7.95009C14.75 12.4438 9.90338 17.1239 8.27588 18.5693C8.12426 18.6866 7.9397 18.75 7.75 18.75C7.5603 18.75 7.37574 18.6866 7.22412 18.5693C5.59662 17.1239 0.75 12.4438 0.75 7.95009C0.75 6.04051 1.4875 4.20914 2.80025 2.85886C4.11301 1.50858 5.89348 0.75 7.75 0.75C9.60652 0.75 11.387 1.50858 12.6997 2.85886C14.0125 4.20914 14.75 6.04051 14.75 7.95009Z"
                                        stroke="#222F30" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                    <path
                                        d="M7.75 10.6501C9.19975 10.6501 10.375 9.44128 10.375 7.95009C10.375 6.4589 9.19975 5.25006 7.75 5.25006C6.30025 5.25006 5.125 6.4589 5.125 7.95009C5.125 9.44128 6.30025 10.6501 7.75 10.6501Z"
                                        stroke="#222F30" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                </svg>
                            </span> North America, USA</a>
                        <a class="tp-line-anim" href="tel:0133456778"><span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18"
                                    fill="none">
                                    <path
                                        d="M17.1326 12.1013L12.8935 10.2014L12.8827 10.196C12.6625 10.1017 12.4222 10.0638 12.1837 10.0858C11.9451 10.1079 11.7158 10.189 11.5165 10.322C11.4931 10.3375 11.4705 10.3543 11.449 10.3724L9.2584 12.2399C7.87058 11.5658 6.43777 10.1438 5.76366 8.774L7.63388 6.55008C7.65188 6.52758 7.66898 6.50508 7.68518 6.48078C7.81517 6.28215 7.89403 6.05447 7.91476 5.81799C7.93549 5.58151 7.89743 5.34358 7.80398 5.12537C7.80363 5.12178 7.80363 5.11816 7.80398 5.11457L5.89867 0.867426C5.77513 0.582362 5.56271 0.344895 5.29313 0.190474C5.02354 0.0360541 4.71124 -0.0270376 4.40285 0.010618C3.18331 0.171096 2.06389 0.770017 1.25366 1.69552C0.443431 2.62102 -0.00219686 3.80982 8.14386e-06 5.03987C8.14386e-06 12.1859 5.81406 18 12.9601 18C14.1902 18.0022 15.379 17.5566 16.3045 16.7463C17.23 15.9361 17.8289 14.8167 17.9894 13.5971C18.027 13.2888 17.9639 12.9765 17.8095 12.7069C17.6551 12.4373 17.4176 12.2249 17.1326 12.1013ZM12.9601 16.56C9.90583 16.5566 6.97759 15.3418 4.81787 13.1821C2.65815 11.0224 1.44336 8.09417 1.44002 5.03987C1.43664 4.161 1.75327 3.31095 2.33079 2.64846C2.90832 1.98597 3.70724 1.55635 4.57835 1.43983C4.578 1.44342 4.578 1.44704 4.57835 1.45063L6.46837 5.68067L4.60805 7.9073C4.58917 7.92902 4.57202 7.95219 4.55675 7.9766C4.42131 8.18442 4.34186 8.42371 4.32609 8.67128C4.31032 8.91884 4.35878 9.16628 4.46675 9.38961C5.28216 11.0573 6.96248 12.725 8.64819 13.5395C8.87316 13.6465 9.12203 13.6933 9.37049 13.6753C9.61894 13.6573 9.85848 13.5752 10.0657 13.4369C10.089 13.4214 10.1113 13.4042 10.1323 13.3856L12.3202 11.5199L16.5503 13.4153C16.5503 13.4153 16.5575 13.4153 16.5602 13.4153C16.4449 14.2875 16.0158 15.0878 15.3532 15.6666C14.6906 16.2454 13.8399 16.563 12.9601 16.56ZM10.0801 4.31986C10.0801 4.1289 10.156 3.94577 10.291 3.81074C10.426 3.67571 10.6092 3.59985 10.8001 3.59985H12.9601V1.43983C12.9601 1.24887 13.036 1.06574 13.171 0.93071C13.306 0.795683 13.4892 0.719825 13.6801 0.719825C13.8711 0.719825 14.0542 0.795683 14.1893 0.93071C14.3243 1.06574 14.4001 1.24887 14.4001 1.43983V3.59985H16.5602C16.7511 3.59985 16.9343 3.67571 17.0693 3.81074C17.2043 3.94577 17.2802 4.1289 17.2802 4.31986C17.2802 4.51082 17.2043 4.69395 17.0693 4.82898C16.9343 4.96401 16.7511 5.03987 16.5602 5.03987H14.4001V7.19989C14.4001 7.39085 14.3243 7.57398 14.1893 7.70901C14.0542 7.84404 13.8711 7.9199 13.6801 7.9199C13.4892 7.9199 13.306 7.84404 13.171 7.70901C13.036 7.57398 12.9601 7.39085 12.9601 7.19989V5.03987H10.8001C10.6092 5.03987 10.426 4.96401 10.291 4.82898C10.156 4.69395 10.0801 4.51082 10.0801 4.31986Z"
                                        fill="#222F30" />
                                </svg>
                            </span> +999 213 2315</a>
                    </div>
            ...
            <div class="row align-items-center">
                <div class="col-xxl-2 col-xl-2 col-6">
                    <div class="tp-header-left-side">
                        ...
                        {{-- <div class="tp-header-lan d-none d-lg-block">
                            <a href="#">
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18"
                                        fill="none">
                                        <path
                                            d="M9 0C7.21997 0 5.47991 0.527841 3.99987 1.51677C2.51983 2.50571 1.36628 3.91131 0.685088 5.55585C0.00389957 7.20038 -0.17433 9.00998 0.172936 10.7558C0.520203 12.5016 1.37737 14.1053 2.63604 15.364C3.89471 16.6226 5.49836 17.4798 7.24419 17.8271C8.99002 18.1743 10.7996 17.9961 12.4442 17.3149C14.0887 16.6337 15.4943 15.4802 16.4832 14.0001C17.4722 12.5201 18 10.78 18 9C17.9975 6.61382 17.0485 4.3261 15.3612 2.63882C13.6739 0.95154 11.3862 0.00251984 9 0ZM9 1.38462C10.4754 1.38305 11.9192 1.81257 13.1538 2.62038V4.32692L11.2353 6.55442L8.51192 6.92308L8.4851 6.90404L6.78289 5.79115C6.63197 5.68484 6.46132 5.60979 6.28097 5.5704C6.10062 5.531 5.91422 5.52808 5.73272 5.56178C5.55122 5.59548 5.37829 5.66514 5.22411 5.76665C5.06993 5.86816 4.9376 5.99948 4.83491 6.15288L3.02279 8.86154C2.87183 9.08726 2.79058 9.35239 2.78914 9.62394L2.76923 12.7592L2.48625 12.9453C1.78669 11.7903 1.40681 10.4701 1.38555 9.11989C1.36429 7.76972 1.70242 6.43818 2.36528 5.26173C3.02813 4.08529 3.99188 3.10625 5.15775 2.42495C6.32361 1.74366 7.64967 1.38461 9 1.38462ZM3.31356 14.0599L3.53164 13.9171C3.72207 13.7915 3.87851 13.6208 3.98706 13.4201C4.09561 13.2195 4.15291 12.9951 4.15385 12.767L4.17202 9.63173L5.98587 6.92308C5.99475 6.92991 6.004 6.93627 6.01356 6.94211L7.71577 8.05586C8.00104 8.2572 8.35204 8.34286 8.69798 8.29558L11.4231 7.92606C11.7591 7.88121 12.067 7.71462 12.2885 7.45788L14.207 5.22865C14.4216 4.97727 14.5391 4.65742 14.5385 4.32692V3.77913C15.4749 4.76982 16.1277 5.99402 16.4287 7.32357C16.7297 8.65312 16.6677 10.0391 16.2493 11.3365L14.8526 10.0592C14.6584 9.881 14.4174 9.76189 14.1579 9.7159C13.8984 9.66991 13.6311 9.69895 13.3875 9.79961L10.7515 10.8943C10.5311 10.9868 10.3383 11.1346 10.1915 11.3233C10.0448 11.512 9.94918 11.7353 9.91385 11.9717L9.70702 13.3728C9.65731 13.71 9.73374 14.0537 9.92168 14.3381C10.1096 14.6225 10.3959 14.8276 10.7256 14.914L12.5827 15.4038L12.7869 15.6089C11.2704 16.479 9.50044 16.8001 7.77497 16.5179C6.0495 16.2358 4.47394 15.3677 3.31356 14.0599ZM13.9327 14.7981L13.5606 14.4251C13.387 14.2509 13.1701 14.126 12.9323 14.0634L11.0769 13.5736L11.2838 12.1725L13.9188 11.0769L15.6635 12.6762C15.2188 13.4818 14.6325 14.2006 13.9327 14.7981Z"
                                            fill="#222F30" />
                                    </svg>
                                    English
                                </span>
                            </a>
                            <div class="tp-header-lan-content">
                                <ul>
                ...
                <div class="col-xxl-6 col-xl-7 d-none d-xl-block">
                    <div class="tp-header-menu tp-header-dropdown text-center">
                            ...
                            <ul>
                                <li class="has-dropdown group">
                                    ...
                                    <ul class="tp-submenu submenu bg-white!">
                                        ...
                                        <li><a class="leading-normal!" href="{{ route('faqs') }}">Frequently Asked Questions</a></li>
                ...
                <div class="col-xxl-4 col-xl-3 col-6">
                    <div class="tp-header-action d-flex justify-content-end">
                        <a href="contact.html" class="tp-btn-event d-none d-xxl-flex">
                        ...
                        <button class="tp-header-search ml-25 d-none d-xl-block">
                            <span class="tp-search-open-btn">
                                <svg class="search-svg" xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                        ...
                        <button class="tp-header-bar tp-offcanvas-open-btn ml-25">
                            <span>
