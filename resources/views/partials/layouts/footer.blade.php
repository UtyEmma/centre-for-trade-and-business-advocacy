      <footer>
         <div class="tp-footer-area pt-100 " data-bg-color="#F7F7F5">
                     ...
                     <div class="col-xl-3 col-md-6 col-sm-6">
                        <div class="tp-footer-widget footer-col-6-1 mb-90">
                           <div class="tp-footer-logo mb-35">
                              <a href="index-2.html">
                                 <img data-width="130" src="assets/img/logo/logo.png" alt="">
                              </a>
                           </div>
                           <div class="tp-footer-text mb-30">
                              <p>A startup vision summary should be a <br>
                                 concise statement that captures the <br>
                                 essence of your company’s</p>
                           </div>
                     ...
                     <div class="col-xl-3 col-md-4 col-sm-6">
                        <div class="tp-footer-widget mb-60">
                           ...
                           <div class="tp-footer-contact-wrap">
                              <span class="tp-footer-contact-location"><a href="#">Av. Javier Prado This No. 560 Of.
                                    No. <br>
                                    2302 San Isidro Lima 27 – Peru <br> Attention: Monday to Friday </a></span>
                              <h4 class="tp-footer-widget-title">Contact Us</h4>
                              <a class="tp-footer-contact-tel d-inline-block mb-35 tp-line-anim "
                                 href="tel:0134566789">Tel. + 01 739 2694</a>
                     ...
                     <div class="row align-items-center">
                        <div class="col-xl-4 col-lg-5 col-md-6">
                           <div class="tp-footer-copyright-text text-center text-md-start pb-20">
                              <p class="mb-0">© 2026 <a href="#">Consora</a>. All Rights Reserved.</p>
                           </div>
                        </div>
                        <div class="col-xl-8 col-lg-7 col-md-6">
                           <div
                              class="tp-footer-copyright-link d-flex justify-content-center justify-content-md-end pb-20">
