               ...
               <div class="col-xl-3 col-md-4 col-sm-6">
                  <div class="tp-footer-widget mb-60">
                     ...
                     <div class="tp-footer-contact-wrap">
                        <span class="tp-footer-contact-location"><a href="#">Av. Javier Prado This No. 560 Of.  No. <br>
                        2302 San Isidro Lima 27 – Peru <br> Attention: Monday to Friday </a></span>
                        <h4 class="tp-footer-widget-title">Contact Us</h4>
                        <a class="tp-footer-contact-tel d-inline-block mb-35 tp-line-anim " href="tel:0134566789">Tel. + 01 739 2694</a>
                        <img src="assets/img/finance/cta/footer-map-2.png" alt="">
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div class="row align-items-center">
                  <div class="col-xl-4 col-lg-5 col-md-6">
                     <div class="tp-footer-copyright-text text-center text-md-start pb-20">
                        <p class="mb-0">© {{ now()->format('Y') }} <a href="#">Consora</a>. All Rights Reserved.</p>
                     </div>
                  </div>
