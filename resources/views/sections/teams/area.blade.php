...
<div class="tp-team-ptb tp-team-style pt-135 pb-110 max-md:pt-20!">
        <div class="container col-md-10 mx-auto">
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <div class="tp-team-heading text-center mb-60">
                        <span class="tp-section-sub tp-fade-anim">{{ $label }}</span>
                        <h2 class="tp-section-title max-md:text-3xl!" data-text-split data-letters-fade-in>{{$headline}}</h2>
                    </div>
                </div>
            </div>
            <div class="row">
