@props([
    ...
    'headline' => 'We welcome conversations that advance better policy, stronger institutions, and fairer markets.',
    'description' => 'Whether you are a policy maker, regulator, researcher, development partner, civil society organisation, private sector actor, or member of the public, we are open to enquiries that align with our work in trade, competition, consumer protection, digital governance, sustainability, and public-sector accountability.',
    'phone' => '+234 812 631 7786',
    'email' => 'info@centre-tba.org',
    'address' => 'No. 46, Agadez Crescent, Wuse 2, Abuja-FCT, Nigeria',
])

<div class="tp-contact-ptb tp-sec-ptb pt-70 pb-20">
    <div class="container col-md-10 mx-auto">
        <div class="row">
            <div class="col-lg-6">
                <div class="tp-contact-wrapper max-md:mb-10!">
                    ...
                    <div class="tp-contact-info tp-fade-anim" data-delay=".5">
                        ...
                        <div class="tp-contact-info-content">
                            <h4 class="tp-contact-info-title">Send us an Email</h4>
                            <p><a class="tp-line-anim" href="mailto:{{ $email }}">{{ $email }}</a></p>
                        </div>
                        </div>
